...
class CameraSettings extends React.Component<CameraSettingsProps, CameraSettingsState> {
  ...
  motion_stabil_lengthHandler(event: any) { this.setState({ motion_fps_scale: parseInt(event.target.value) }); }
  ...
  handleSubmit(event: any) {
    ...
    fetch("http://localhost:8000/new_camera_settings", {
      method: "POST",
  ...
  handleDelete() {
    ...
    fetch("http://localhost:8000/delete_camera", {
      method: "POST",
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({
        auth_cookie: Cookies.get("auth"),
      ...
      <div className="camera_settings_focus">
        ...
        <div className="camera_settings_container">
          ...
          <form onSubmit={this.handleSubmit}>
            ...
            <br></br>
            <label>Movement Stabilization Length: <input onChange={this.motion_fps_scaleHandler} value={this.state.motion_stabil_length} className="number_input" type="number" min="1"></input></label>
            <br></br>
            ...
            <br></br>
            <label>Minimum Changed Pixels: <input onChange={this.min_changed_pixelsHandler} value={this.state.min_changed_pixels} className="number_input" type="number" min="0" max="1" step="0.01" id="min_changed_pixels"></input></label>
            <br></br>
            <hr></hr>
            ...
            <input type="submit" value="Save" id="camera_settings_submit_button" onClick={this.handleSubmit}></input>
          </form>
